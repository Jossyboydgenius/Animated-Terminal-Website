...
function enterKey(e) {
  ...
  if (pw) {
    ...
    if (e.keyCode == 13) {
      ...
      git = commands.length;
      addLine("guest@AweJoseph:~$ " + command.innerHTML, "no-animation", 0);
...
if (e.keyCode == 40 && git < commands.length - 1) { // Down arrow key
  git += 1;
  textarea.value = commands[git];
  command.innerHTML = textarea.value;
...
function commander(cmd) {
  ...
  switch (cmd.toLowerCase()) {
    ...
    case "history":
      ...
      break;
    case "email":
      addLine('Opening mailto:<a href="mailto:awejosepholaitan@gmail.com">awejosepholaitan@gmail.com</a>...', "color2", 80);
      newTab(email);
      break;
    case "clear":
      setTimeout(function() {
